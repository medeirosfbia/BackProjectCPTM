        ...
        public async Task CriarTabelasDominioAsync()
        {
            ...
            await CriarESeed(connection, "GEA_TX_MUNICIPIO",
                ...
                new List<(int, string)> {
                    ...
                    (9, "Jandira"), (2, "Jundiaí"), (33, "Juquitiba"), (46, "Mairinque"), (34, "Mairiporã"),
            ...
            await CriarESeed(connection, "GEA_TX_LINHA_CPTM",
                ...
                new List<(int, string)> {
                    ...
                    (7, "Linha 07 - Rubi / Linha 08 - Diamante"), (8, "Linha 08 - Diamante / Linha 09 - Esmeralda"),
                    (9, "Linha 09 - Esmeralda / Linha 10 - Turquesa"), (10, "Linha 07 - Rubi / Linha 08 - Diamante / Linha 11 - Coral"),
            ...
            await CriarESeed(connection, "GEA_SIM_NAO",
                "CREATE TABLE GEA_SIM_NAO (CODIGO NUMBER PRIMARY KEY, DESCRICAO VARCHAR2(4000))",
                new List<(int, string)> {
